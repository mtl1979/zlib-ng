/*
 * Fill Window with VMX-optimized hash shifting
 *
 * Copyright (C) 2017 Mika T. Lindqvist <postmaster@raasu.org>
 *
...
ZLIB_INTERNAL void fill_window_vmx(deflate_state *s) {
    const vector unsigned short vmx_wsize = vec_splats(s->w_size);
